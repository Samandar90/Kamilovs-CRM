...
const EMPTY_HINTS = ["Какая выручка сегодня?", "Сколько пациентов?"];
          ...
          <div className="mt-4 flex w-full max-w-sm flex-col gap-2">
            {EMPTY_HINTS.map((hint) => (
              <button
                ...
                className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 transition-colors duration-150 hover:bg-slate-100"
              >
                {hint}
              </button>
            ))}
